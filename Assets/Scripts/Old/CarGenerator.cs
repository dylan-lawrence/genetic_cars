...
public class CarGenerator : MonoBehaviour {
	...
	public void Generate (Genome g) {
		...
		wheel1.GetComponent<CircleCollider2D> ().radius = Genome.GeneToInt (g [13]) / 255.0f;
		wheel2.GetComponent<CircleCollider2D> ().radius = Genome.GeneToInt (g [15]) / 255.0f;
